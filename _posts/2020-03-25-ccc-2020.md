...
I enjoyed solving this year's CCC problems and I hope that you enjoy them as well! My solutions in C++ are available [here](https://github.com/crackersamdjam/Programming-Contest-Solutions) and below.
...
The log factor comes from accessing the map. I used an std::map instead of std::unordered_map because it's faster in practice when there are fewer than 10^5 elements.
